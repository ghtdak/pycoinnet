...
def dns_bootstrap_host_port_q(network_info,
    ...
    superpeer_ip_queue.task = asyncio.Task(bootstrap_superpeer_addresses(
        dns_bootstrap))
...
def new_queue_of_timestamp_peeraddress_tuples(
        network_info,
        timestamp_peeraddress_tuple_queue=None,
        ...
        while 1:
            try:
                ...
                for da in date_address_tuples:
                    yield from timestamp_peeraddress_tuple_queue.put(
                        (-da[0], da[1]))
